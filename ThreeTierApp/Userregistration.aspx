<%@ Page Language="C#" AutoEventWireup="true" 
    CodeBehind="UserRegistration.aspx.cs" 
    Inherits="ThreeTierApp.UserRegistration" %>
    ...
    <div style="margin: 0px auto; padding-left: 370px; padding-right: 30px; overflow: auto;">
        <div>
            <table width="50%">
                ...
                <tr>
                    <td align="center" colspan="2">
                        If you like code please like and comment Thanks Friends.</td>
                </tr>
            </table>
        </div>
    </div>
